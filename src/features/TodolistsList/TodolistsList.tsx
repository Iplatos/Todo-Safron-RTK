...
import {CreateTaskType, TaskStatuses} from 'api/todolists-api'
...
export const TodolistsList: React.FC<PropsType> = ({demo = false}) => {
    ...
    const addTask = useCallback(function (arg:CreateTaskType) {
        const thunk = addTaskTC({taskTitle:arg.taskTitle, todolistId:arg.todolistId})
        dispatch(thunk)
    }, [])
